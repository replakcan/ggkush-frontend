...
export default function Login() {
  ...
  return (
    <form className="flex flex-column gap-4 justify-content-center align-content-center" onSubmit={handleSubmit(onSubmit)}>
      <span className={`p-float-label min-w-min`}>
        <InputText
